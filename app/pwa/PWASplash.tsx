...
export default function PWASplash({ children, logo }: { children: React.ReactNode, logo: string | null }) {
    const [showSplash, setShowSplash] = useState(true);
    const { setLogo } = useConfigStore();

    useEffect(() => {
        // Al abrir la PWA, guardamos el logo en la memoria global del celular
