...
export default function TareasManager({ tareas, idVehiculo, dolarActual }: { tareas: any[]; idVehiculo: number; dolarActual?: number }) {
  ...
  const rate = Number(dolarActual || dolarBlue || 1400);
